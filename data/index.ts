...
export const projects = [
  {
    ...
    link: "https://anyelopetit.github.io/personal-portfolio/",
    sourceCode: "https://github.com/anyelopetit",
  },
  // {
  //   id: 2,
...
export const workExperience = [
  {
    ...
    desc: "Develop custom websites for business managers using WordPress (for content management) and React (for dynamic interfaces). Deliver end-to-end solutions including UI/UX design, API integrations, and server deployment.",
